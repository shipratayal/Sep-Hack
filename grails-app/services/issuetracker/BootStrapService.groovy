...
import com.User
import com.UserRole
import com.nexthoughts.issuetracker.Team
...
class BootStrapService {
    ...
    public void createTeam() {
        if (!Team.countByName("AugHackthon")) {
            Team team = new Team(name: 'AugHackthon', teamProfile: TeamProfile.DEVELOPER)
            AppUtil.save(team)
        }
        if (!Team.countByName("SepHackthon")) {
