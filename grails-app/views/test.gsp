                                                        ...
                                                        <td valign="top" class="mcnTextContent"
                                                                    ...
                                                                    style="font-size:20px"><span
                                                                        style="color:#3abdf1"><span
                                                                            style="font-family:lucida sans unicode,lucida grande,sans-serif"><span
                                                                                style="line-height:1.6em">Hi</span>&nbsp;${sendTo}<span
                                                                    ...
                                                                    style="font-size:25px"><span
                                                                        style="color:#3abdf1"><font
                                                                            face="lucida sans unicode, lucida grande, sans-serif"><span
                                                                                style="line-height:38.4px">A new issue was <span
                                                                                    style="font-family:lucida sans unicode,lucida grande,sans-serif">created by ${mail?.createdBy?.firstName}</span>
                                                            ...
                                                            <div style="text-align: center;"><span
                                                                    style="font-size:17px"><span
                                                                        style="color:#666666">Issue Title : ${mail?.title}</span>
                                                            </span><br>
                                                                &nbsp;</div>

                                                            <div style="text-align: center;"><span
                                                                    style="font-size:17px"><span
                                                                        style="color:#666666">Click the show issue link to view the issue</span>
                                                            </span><br>
                                                                &nbsp;</div>
                                                    ...
                                                    <tr>
                                                        <td align="center" valign="middle" class="mcnButtonContent"
                                                            ...
                                                            <a class="mcnButton " title="Activate Account"
                                                               href="${createLink(controller: 'issue', action: 'index', params: [id: "${mail?.issueId}"], absolute: true)}"
                                                               target="_blank"
